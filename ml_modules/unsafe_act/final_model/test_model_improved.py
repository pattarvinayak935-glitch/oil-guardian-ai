...
def predict(report_text):
    model = joblib.load("unsafe_act_model_improved.pkl")
    vectorizer = joblib.load("unsafe_act_vectorizer_improved.pkl")
    le = joblib.load("unsafe_act_label_encoder_improved.pkl")
...
print("=" * 60)
print("IMPROVED MODEL WITH THRESHOLD - REAL-WORLD TEST")
print("=" * 60)
